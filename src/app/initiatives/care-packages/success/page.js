...
export default async function CarePackagesSuccessPage({ searchParams }) {
  const sessionId = searchParams.session_id

  if (!sessionId) {
    redirect('/initiatives/care-packages')
  }
  ...
  try {
    ...
    if (metadata.create_account === 'true' && metadata.email && !metadata.member_id) {
      // We'll need to send them an invite or show them how to create an account
      // For now, we'll just flag that they wanted this
      accountCreated = false // Will show them the join link
    }
      ...
      <section className="bg-gradient-to-b from-green-600 to-green-700 text-white py-16">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-green-100">
            Your generosity will help provide essential supplies to protestors standing up for our communities.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-xl mx-auto px-6">
          <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 border border-gray-200">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                ...
                <span className="text-gray-900">ICE Protestor Care Packages</span>
              </div>
              {donorInfo?.email && (
                <div className="flex justify-between">
          ...
          <div className="mt-8 bg-white rounded-xl p-6 border border-gray-200">
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              ...
              <li className="flex gap-3">
                ...
                <span>Funds are used to purchase care package supplies</span>
              </li>
              <li className="flex gap-3">
                ...
                <span>Volunteers assemble and distribute packages to protest sites</span>
              </li>
              <li className="flex gap-3">
                ...
                <span>You'll receive email updates on the initiative's impact</span>
              </li>
            </ul>
          </div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <Link
              href="/initiatives/care-packages"
          ...
          <div className="mt-8 text-center">
            ...
            <div className="flex justify-center gap-4">
              <a
                href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('I just donated to help provide care packages for ICE protestors. Join me in supporting those on the front lines!')}&url=${encodeURIComponent('https://members.votelabor.org/initiatives/care-packages')}`}
                target="_blank"
              ...
              <a
                href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent('https://members.votelabor.org/initiatives/care-packages')}`}
                target="_blank"
                rel="noopener noreferrer"
