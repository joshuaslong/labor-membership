        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-stone-200 rounded">
            <div className="px-4 py-3 border-b border-stone-200 flex items-center justify-between">
              ...
              {userIsAdmin && (
                <Link href={`/workspace/admin/groups?chapter=${id}`} className="text-xs text-gray-500 hover:text-gray-700">Manage</Link>
              )}
            </div>
            {groupsWithCounts.length > 0 ? (
              ...
              <div className="px-4 py-6 text-center text-sm text-gray-500">
                No groups
                {userIsAdmin && (
                  <> — <Link href={`/workspace/admin/groups?chapter=${id}`} className="text-labor-red hover:underline">create one</Link></>
                )}
              </div>
            )}
          </div>
