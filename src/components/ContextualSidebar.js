...
function ContextualSidebar({ items = [] }) {
  ...
  return (
    <nav className="w-60 bg-white border-r border-stone-200 md:sticky md:top-[61px] h-full md:h-[calc(100vh-61px)] overflow-y-auto flex-shrink-0" aria-label="Section navigation">
